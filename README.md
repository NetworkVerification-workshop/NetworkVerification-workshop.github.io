...
**Introduction of the Ultra-scale AIOps Lab** by [Dr. Jorge Cardoso](https://jorge-cardoso.github.io/), Chief Architect, AIOps (8:20 AM - 8:40 AM CEST)
...
**Keynote: Practical (privacy preserving) federated ML for networked system behaviours** by [Prof. Jon Crowcroft](https://www.cst.cam.ac.uk/people/jac22), Full Professor at Cambridge University, London (8:50 - 9:20 AM CEST)
...
**Talk: Analyzing Learning-Based Networked Systems with Formal Verification** by [Prof. Marco Canini](https://mcanini.github.io/), Associate Professor at KAUST, Jeddah (9:50 - 10:20 AM CEST)
...
**Keynote: Assessing the Performance of (Smart) Network Interface Cards** by [Prof. Marco Chiesa](https://marchiesa.bitbucket.io/), Assistant Professor at KTH, Stockholm (10:20 - 10:50 AM CEST)
...
**Talk: Is Network Verification the right answer?** by [Dr. Artur Hecker](https://www.linkedin.com/in/artur-hecker-25027818), Director of networking research and Expert at the Advanced Wireless Technology Lab, Huawei Munich Research Center, Munich (12:00 - 12:30 PM CEST)
...
**Lunch Break (30 mins)** (12:30 - 13:00 PM)

**Talk: From hardware to software, or from software to hardware? Abstractions for programmable packet processing in the NIC** by [Dr. Roberto Bifulco](https://www.robertobifulco.it/), Manager of Intelligent Software Systems Group at NEC, Heidelberg (13:00 - 13:30 PM CEST)
